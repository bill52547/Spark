...
//
// from Github: https://github.com/aminnj/cpptqdm
#ifndef INCLUDE_TQDM_H
#define INCLUDE_TQDM_H
#include <unistd.h>
#include <chrono>
#include <ctime>
#include <numeric>
...
private:
    ...
    bool in_screen = 0; //(system("test $STY") == 0);
    bool in_tmux =  0; //(system("test $TMUX") == 0);
